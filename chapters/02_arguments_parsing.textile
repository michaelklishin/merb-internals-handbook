 ...
 * _reload\_templates_ supposed to let you avoid templates inlining and reload them on every request. NoOp at the moment of writing.
 ...
 * _default\_cookie\_domain_ is a domain used for cookies if no explicit domain specified.
