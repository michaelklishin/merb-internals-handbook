...
This chapter is *slightly* but outdated. Merb now supports streaming with
Thin and Ebb thanks to middleware-level solution called stream wrapper.

This chapter will eventually be updated.
